  ...
  if (area === "header") {
    return (
      <svg className={styles.headerDoodles} viewBox="0 0 560 220" aria-hidden="true">
        ...
        />
        <path d="M247 175c8-13 16-17 31-17m-12-9 13 11-9 14" className={styles.doodleStroke} />
        <path
          d="M393 50c14-31 41-47 59-34 19 13 14 44-7 70-22 25-36 46-19 57 17 11 39 3 58-15"
          className={styles.doodleStroke}
        />
        <path d="M456 125c5-2 11-4 18-3m-7-8 12 9-10 13" className={styles.doodleStroke} />
      </svg>
    );
  }
  ...
  return (
    <>
      <svg className={styles.frameworkArrow} viewBox="0 0 320 220" aria-hidden="true">
        ...
        />
        <path d="M180 171c11-2 22-2 36-1m-9-12 24 11-14 23" className={styles.annotationStrokeBold} />
      </svg>
      ...
      <svg className={styles.useCasesArrow} viewBox="0 0 260 220" aria-hidden="true">
        <path
          ...
          className={styles.annotationStrokeBold}
        />
        <path d="M123 160c14 2 26 2 38 0m-9-12 20 12-12 20" className={styles.annotationStrokeBold} />
      </svg>
